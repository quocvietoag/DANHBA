...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gd_chinh);

        //Thêm điều kiển
        addControl();
        //Đọc dữ liệu
        readData();
        //Khởi tạo biến Intent
        Intent intent=getIntent();
        String id = intent.getStringExtra("TK");
        tv_ID.setText(id);
    }

    private void addControl() {
        tv_ID=findViewById(R.id.tv_ID);
        lvDanhsach=findViewById(R.id.lv_dasach);
        list=new ArrayList<>();
      //  adapter=new AdapterUser(this,list1);
